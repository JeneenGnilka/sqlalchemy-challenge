...
def tobs():
   ...
   # Create session (link) from Python to the DB
    ...
    # Create a list of dictionaries for each tobs data point
...
def start_date(start):
    """Return JSONified min, max, and average temperatures from the given start date to the end of the dataset."""
   # Create session (link) from Python to the DB
    session = Session(engine)

    # Query min, max, and average temperatures from the start date to the end of the dataset
...
def start_end_date(start, end):
    """Return JSONified min, max, and average temperatures from the given start date to the given end date."""
   # Create session (link) from Python to the DB
    session = Session(engine)

    # Query min, max, and average temperatures from the start date to the end date
    results = session.query(func.min(Measurement.tobs), func.max(Measurement.tobs), func.avg(Measurement.tobs)).\
